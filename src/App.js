        ...
        <div className="panel">
          {hadWrongAnswer ? (
            ...
            <div className={'column'}>
              ...
              <p className={'text'}>
                Ти вдало пройшов цей тест, тому отримуєш приз - СЮРПРИЗ ВЕЧІРКУ!!!</p>
              <p className={'text'}>22 червня о 16:00 тебе будуть чекати в твоїй квартирі</p>
              <p className={'text'}>(додаткова умова: 22 червня о 15:00 тобі назначена зустріч з Ткаченко Анастасією в твоїй квартирі. У вас відбудеться обмін твоїх ключів на 1 годину проведення часу за кавою/пивом з Гуменою Варварою)</p>
              <p className={'text'}>Дрес-код: гарний (по можливості)</p>
              <p className={'text'}>Підготовлена їжа, закуски, напої вітаються. Приємного очікування!
              </p>
            </div>
          )}
        </div>
